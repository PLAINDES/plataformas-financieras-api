...
Revision ID: ae5c890e945a
Revises: 
Create Date: 2026-03-23 00:17:16.655832
...
def upgrade() -> None:
    ...
    op.create_table('main_template_complements',
    sa.Column('id', mysql.BIGINT(unsigned=True), autoincrement=True, nullable=False),
    ...
    op.create_table('main_master_templates',
    sa.Column('id', mysql.BIGINT(unsigned=True), autoincrement=True, nullable=False),
    sa.Column('nombre', sa.String(length=255), nullable=False),
    ...
    op.create_table('main_calculations',
    sa.Column('id', mysql.BIGINT(unsigned=True), autoincrement=True, nullable=False),
    sa.Column('calculation_file_id', mysql.BIGINT(unsigned=True), nullable=True),
    sa.Column('user_id', mysql.BIGINT(unsigned=True), nullable=False),
    sa.Column('code', sa.String(length=64), nullable=False),
    sa.Column('type', sa.Enum('valora', 'kapital', name='calculationtype'), nullable=False),
    sa.Column('data', sa.JSON(), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    ...
    op.create_table('main_template_codes',
    sa.Column('id', mysql.BIGINT(unsigned=True), autoincrement=True, nullable=False),
    sa.Column('template_code_image_id', mysql.BIGINT(unsigned=True), nullable=True),
    sa.Column('type', sa.Enum('valora', 'kapital', name='templatecodetype'), nullable=False),
    ...
    op.create_table('main_templates',
    sa.Column('id', mysql.BIGINT(unsigned=True), autoincrement=True, nullable=False),
    sa.Column('nombre', sa.String(length=255), nullable=False),
    ...
    sa.Column('type', sa.Enum('valora', 'kapital', name='reporttype'), nullable=False),
    ...
    sa.Column('contentEditor', sa.Text(), nullable=True),
    sa.Column('portada_id', mysql.BIGINT(unsigned=True), nullable=True),
    ...
    op.create_table('main_template_codes_main_templates',
